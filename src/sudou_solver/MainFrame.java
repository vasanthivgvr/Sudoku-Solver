...
public class MainFrame extends javax.swing.JFrame {
     ...
     */
    // if you have solved half of puzzle and you checked if its correct or not then want to try again for incorrect cells
    private void continueSolving(){
        ...
        for(int i=0; i<9; i++){
            for(int j=0; j<9; j++){
                if(btns[i][j].getText() != sudokuBoard[i][j]){
                    btns[i][j].setText("");
    ...
    // check wheather puzzle has been solved correctly or not 
    private boolean checkPuzzle(){
        JButton predefinedBtn[] = {r1c3,r1c5,r1c7,r1c9,r2c2,r2c4,r2c8,r3c2,r3c3,r3c6,r3c8,r4c1,r4c7,r4c9,r5c2,r5c4,
                                    r5c6,r6c1,r6c6,r6c8,r6c9,r7c1,r7c2,r7c7,r8c5,r8c8,r8c9,r9c2,r9c3,r9c5,r9c6,r9c9};
        JButton btns[][] = {
            {r1c1,r1c2,r1c3,r1c4,r1c5,r1c6,r1c7,r1c8,r1c9},
            {r2c1,r2c2,r2c3,r2c4,r2c5,r2c6,r2c7,r2c8,r2c9},
            {r3c1,r3c2,r3c3,r3c4,r3c5,r3c6,r3c7,r3c8,r3c9},
...
//            }
    ...
    // create a method for selection buttons
    private void AssignTurn(JButton btn){
        ...
        // after calling the perticular button set the bgcolor as blue
    ...
    private void checkMoves(){
        ...
        for(int i=0; i<9; i++){
            for(int j=0; j<9; j++){
                ...
                if(flag == true){
                    if(btns[i][j].getText() != sudokuBoard[i][j] && btns[i][j].getText() != ""){
                        btns[i][j].setBackground(Color.red);
                    }
                    if(btns[i][j].getText() == sudokuBoard[i][j]){
                        btns[i][j].setBackground(Color.green);
    ...
    private void Solution(){
        ...
        if(globalFlag == true){
            ...
            for(int i=0; i<9; i++){
                ...
                // traverse from predefined array
                for( int k=0; k<predefinedBtn.length; k++){
                    if(btns[i][j] == predefinedBtn[k]){
                        flag = false;
                    }
                ...
                if(flag == true){
                    btns[i][j].setText(sudokuBoard[i][j]);
                    btns[i][j].setForeground(Color.black);
                }
                }
            }
    ...
    private void ResetSudoku(){
        ...
        // for loop to check if current cell is not predefined then reset its value if its predefined then dont do anythinig
        for(int i=0; i<9; i++){
            for(int j=0;j<9; j++){
                boolean flag = true;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 140, 140));
        ...
        r1c5.setBackground(new java.awt.Color(102, 102, 255));
        ...
        r2c4.setBackground(new java.awt.Color(102, 102, 255));
        ...
        r3c6.setBackground(new java.awt.Color(102, 102, 255));
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 30, 140, 140));
        ...
        r2c8.setBackground(new java.awt.Color(102, 102, 255));
        ...
        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 30, 140, 140));

        jPanel7.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        r4c7.setBackground(new java.awt.Color(102, 102, 255));
        ...
        r4c9.setBackground(new java.awt.Color(102, 102, 255));
        ...
        r6c9.setBackground(new java.awt.Color(102, 102, 255));
        ...
        r6c8.setBackground(new java.awt.Color(102, 102, 255));
        ...
        getContentPane().add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 170, 140, 140));

        jPanel5.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        r4c1.setBackground(new java.awt.Color(102, 102, 255));
        ...
        r6c1.setBackground(new java.awt.Color(102, 102, 255));
        ...
        getContentPane().add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 140, 140));
        ...
        r6c6.setBackground(new java.awt.Color(102, 102, 255));
        ...
        getContentPane().add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 170, 140, 140));
        ...
        getContentPane().add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 310, 140, 140));
        ...
        r9c9.setBackground(new java.awt.Color(102, 102, 255));
        ...
        getContentPane().add(jPanel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 310, 140, 140));
        ...
        r9c5.setBackground(new java.awt.Color(102, 102, 255));
        ...
        getContentPane().add(jPanel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 310, 140, 140));
        ...
        getContentPane().add(t1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 470, 40, 40));
        ...
        getContentPane().add(t4, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 470, 40, 40));
        ...
        getContentPane().add(t3, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 470, 40, 40));
        ...
        getContentPane().add(t2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 470, 40, 40));
        ...
        getContentPane().add(t7, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 470, 40, 40));
        ...
        getContentPane().add(t6, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 470, 40, 40));
        ...
        getContentPane().add(t5, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 470, 40, 40));
        ...
        getContentPane().add(t9, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 470, 40, 40));
        ...
        getContentPane().add(t8, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 470, 40, 40));
        ...
        getContentPane().add(reset, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 540, 80, 30));
        ...
        getContentPane().add(exit, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 540, 80, 30));
        ...
        getContentPane().add(checkMoves, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 540, 110, 30));
        ...
        getContentPane().add(solution, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 540, 130, 30));

        jButton1.setBackground(new java.awt.Color(0, 153, 153));
        jButton1.setForeground(new java.awt.Color(255, 255, 255));
        jButton1.setText("Check Puzzle");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 580, 130, 30));

        jButton2.setBackground(new java.awt.Color(255, 102, 255));
        jButton2.setText("Continue Solving");
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton2ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 580, 130, 30));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel1.setText("Sudoku Puzzle");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 0, 140, -1));
    ...
    private void r1c5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_r1c5ActionPerformed
        // TODO add your handling code here:
        JOptionPane.showMessageDialog(this, "This Place is Already Allocated", "Message", HEIGHT);
    ...
    private void resetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resetActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(frame, "Confrim If you want to reset!.", "Reset", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_NO_OPTION)
        {
            ResetSudoku();
        }
    ...
    private void exitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exitActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(frame,"Confrim If you want to Exit!", "Sudoku Puzzle", JOptionPane.YES_NO_OPTION)== JOptionPane.YES_NO_OPTION)
        {
            System.exit(0);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JFrame frame = new JFrame();
        if(checkPuzzle() == true){
            JOptionPane.showMessageDialog(frame, "Puzzle Solved","Sudoku Puzzle",JOptionPane.YES_OPTION);
        }
        else{
            JOptionPane.showMessageDialog(frame, "Incorrect Puzzle","Sudoku Puzzle",JOptionPane.YES_OPTION);
        }
